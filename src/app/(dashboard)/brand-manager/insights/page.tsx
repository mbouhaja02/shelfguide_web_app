      ...
      >
        <div className="space-y-3">
          {recommendations.map((rec, i) => {
            ...
            return (
              <div key={i} className={`rounded-2xl border border-[#e2e9f2] border-l-4 ${severityBorder[rec.severity]} bg-white p-4 hover:shadow-md hover:shadow-black/[0.04] transition-all`}>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {underPerforming.map((store) => (
            <div key={store.storeId} className="rounded-2xl border border-[#e2e9f2] bg-white p-5 hover:shadow-md hover:shadow-black/[0.04] transition-all">
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                <div className="rounded-xl bg-[#f0f3f7] p-2">
