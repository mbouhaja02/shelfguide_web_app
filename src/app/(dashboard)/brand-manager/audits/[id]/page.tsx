  ...
  if (!audit) {
    return (
      <EmptyState
        ...
        action={
          <Link href="/brand-manager/audits" className="inline-flex items-center gap-2 rounded-xl border border-border/60 bg-white px-4 py-2 text-[13px] font-medium hover:bg-slate-50 transition-colors">
            Retour
          </Link>
        }
      />
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-3">
        <Link href="/brand-manager/audits" className="mt-1 flex h-8 w-8 items-center justify-center rounded-lg hover:bg-slate-100 transition-colors">
