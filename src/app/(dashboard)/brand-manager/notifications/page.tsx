...
const iconMap = { alert: AlertTriangle, warning: AlertCircle, success: CheckCircle2, info: Info };
const colorMap = { alert: 'text-red-500 bg-red-50', warning: 'text-amber-500 bg-amber-50', success: 'text-green-500 bg-green-50', info: 'text-blue-500 bg-blue-50' };
        ...
        {notifications.map((notif) => {
          ...
          return (
            <Link key={notif.id} href={notif.actionUrl || '#'}>
              <div className={cn('rounded-xl border border-border/60 bg-white p-4 flex items-start gap-3 hover:shadow-md hover:shadow-black/[0.04] transition-all cursor-pointer', !notif.read && 'border-l-4 border-l-indigo-500')}>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    {!notif.read && <div className="h-2 w-2 rounded-full bg-indigo-500" />}
                  </div>
