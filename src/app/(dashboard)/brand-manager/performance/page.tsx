      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {categoryPerformance.map((cat) => (
            <div key={cat.category} className="rounded-2xl border border-[#e2e9f2] bg-white overflow-hidden hover:shadow-md hover:shadow-black/[0.04] transition-all">
              ...
              <div className="p-4">
                <div className="grid grid-cols-2 gap-2">
                  <div className="rounded-xl bg-[#f0f3f7] p-2.5 text-center">
