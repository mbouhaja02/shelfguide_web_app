    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        {departments.map((dept) => {
          ...
          return (
            <div key={dept.id} className="rounded-2xl border border-[#e2e9f2] bg-white hover:shadow-md hover:shadow-black/[0.04] transition-all p-5">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#f0f3f7]">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="rounded-xl bg-[#f0f3f7] p-3">
                  ...
                  <div className="rounded-xl bg-[#f0f3f7] p-3 flex items-center gap-2">
