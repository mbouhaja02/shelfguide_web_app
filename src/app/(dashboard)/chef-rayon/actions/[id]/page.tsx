  ...
  if (!action) {
    return (
      <EmptyState
        ...
        action={
          <Link href="/chef-rayon/actions" className="inline-flex items-center gap-2 rounded-2xl border border-[#e2e9f2] bg-white px-4 py-2 text-[13px] font-medium hover:bg-[#f8fafb] transition-colors">
            Retour aux actions
          </Link>
        }
      />
  ...
  return (
    <div className="space-y-5 max-w-3xl">
      <div className="flex items-start gap-3">
        <Link href="/chef-rayon/actions" className="mt-1 flex h-8 w-8 items-center justify-center rounded-lg hover:bg-[#fafbfd] transition-colors">
      ...
      {audit && (
        <div className="rounded-2xl border border-[#e2e9f2] bg-white overflow-hidden">
          ...
          <div className="p-5">
            <Link href={`/chef-rayon/audits/${audit.id}`} className="flex items-center justify-between p-3 rounded-2xl border border-[#e2e9f2] hover:bg-[#f8fafb] transition-colors">
              <div>
