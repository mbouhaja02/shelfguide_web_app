...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <div className="absolute top-0 -left-40 h-[500px] w-[500px] rounded-full bg-blue-200/30 blur-[120px]" />
      ...
      <div className="relative z-10 w-full max-w-[420px] animate-fade-in">
        ...
        <div className="mb-10 text-center">
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl overflow-hidden shadow-xl shadow-[#2d9cdb]/20">
        ...
        <div className="rounded-2xl border border-white/60 bg-white/80 backdrop-blur-xl p-7 shadow-xl shadow-black/[0.04]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-10 rounded-lg bg-[#2d9cdb] text-white text-sm font-medium shadow-lg shadow-[#2d9cdb]/25 hover:shadow-[#2d9cdb]/40 hover:brightness-110 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2"
            >
              {loading ? (
        ...
        <div className="mt-5 rounded-xl border border-border/50 bg-white/60 backdrop-blur-sm p-4">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full flex items-center gap-3 rounded-lg px-3 py-2 text-left hover:bg-[#f0f3f7]/60 transition-colors group"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 rounded-lg px-3 py-2 text-left hover:bg-[#f0f3f7]/60 transition-colors group"
            >
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#f0f3f7] text-primary text-[11px] font-bold group-hover:bg-[#e8f0f8] transition-colors">SB</div>
              <div>
